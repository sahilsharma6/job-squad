...
const AboutUs = () => {
  ...
  <div className="relative flex items-center justify-start pl-10 h-full max-w-6xl">
    <div className='max-w-6xl'>
      <h1 className="text-4xl font-bold text-white font-ubuntu">About Us</h1>
      <h2 className="text-white pt-3">Get latest Updates and News Here</h2>
    </div>
  </div>
</div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto font-lato font-normal">
            ...
            We help businesses find the perfect match for their project needs.
          </p>
        </div>
            ...
            <div className="w-full md:w-1/2 space-y-6">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-gray-600">Fast tax & support for your projects</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="h-6 w-6 rounded-full bg-blue-100 flex items-center justify-center">
                    <svg className="h-4 w-4 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
