...
const HowItWorks = () => {
  return (
    <div className="bg-gray-50 py-16 px-8">
      <h3 className="text-center text-primary-500 text-lg font-semibold mb-2">
        Our Work Process
      </h3>
      <h2 className="text-4xl font-bold text-center mb-12">How it Works?</h2>
      <div className="relative   max-w-5xl mx-auto">
        <div className="hidden md:block absolute  top-[20%] left-32 right-0 w-[75%] h-[2px] bg-primary-500"></div>
        ...
        <div className="flex flex-col md:flex-row items-center md:justify-between relative gap-10">
          <div className="flex flex-col items-center text-center md:w-1/4 relative">
            <div className="bg-primary-100 p-4 rounded-full mb-4 relative z-10">
          ...
          <div className="flex flex-col items-center text-center md:w-1/4 relative">
            <div className="bg-primary-100 p-4 rounded-full mb-4 relative z-10">
              <HelpCircle className="text-primary-500 w-8 h-8" />
            </div>
