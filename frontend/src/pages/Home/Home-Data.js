...
export const categories = [
    {
      title: "Management",
      subtitle: "965 Jobs Available",
      icon: Building2, // Replace with actual icon
    },
    {
      title: "Retail & Products",
      subtitle: "563 Jobs Available",
      icon: Building2,
    },
    {
      title: "Management",
  ...
  export const companies = [
    {
      title: "MNCs",
      subtitle: "2K+ are actively hiring",
      icon: [
...
export const JobsCategories = [
    ...
    { id: 'ux', label: 'UX Designer', icon: '✏️' },
  ];
  ...
  export const jobs = [
    ...
    },
    {
      ...
      tags: ['Marketing', 'Creative', 'Manager'],
      category: 'sales'
    },
    {
      id: 3,
    ...
    },
    {
      ...
      location: 'London',
      salary: '80000-95000',
      deadline: '1st Mar, 2024',
      tags: ['Figma', 'Adobe XD', 'Remote'],
      category: 'ui'
    },
    {
      id: 5,
