      ...
      <div className=" mx-auto flex flex-col lg:flex-row items-center gap-8 max-w-6xl">
        ...
        <div className="text-white flex-shrink-0 lg:w-1/3 text-center lg:text-left">
          ...
          <p className="mt-4 text-base sm:text-lg opacity-90 font-lato font-normal">
            Search and connect with the right candidates faster. Tell us what you are 
            looking for, and we will get to work for you.
          </p>
          <Button className="mt-6 bg-white text-blue-light hover:bg-gray-100 transition-all duration-300 group">
            Explore
